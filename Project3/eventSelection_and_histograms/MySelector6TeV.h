...
#ifndef MySelector6TeV_h
#define MySelector6Tev_h
...
class MySelector6TeV : public TSelector {
public :
  ...
  // TTreeReaderArray<float> tau_pt_syst = {fReader, "tau_pt_syst"};
   ...
   MySelector6TeV(TTree * /*tree*/ =0) { }
   virtual ~MySelector6TeV() { }
...
#ifdef MySelector6TeV_cxx
void MySelector6TeV::Init(TTree *tree)
{
...
#endif // #ifdef MySelector6TeV_cxx
