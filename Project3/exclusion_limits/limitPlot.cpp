{
  ...
  ifstream limitinput("inputs/inputs_ee_masses.txt");
  limitinput >> Nmasses;
...
//   xsecG->GetHistogram()->GetYaxis()->SetRangeUser(0,100);
  ...
  leg->AddEntry(xsecG,"Z' #rightarrow e#bar{e}","PL");
